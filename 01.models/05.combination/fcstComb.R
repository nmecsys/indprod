...
# NIVEL -------------------------------------
nivel_sajuste <- cbind(resultadosSARIMA$IN[,"nivel_sajuste"],resultadosKF_univ$IN[,"nivel_sajuste"],resultadosKF_mult$IN[,"nivel_sajuste"],resultadosLM$IN[,"nivel_sajuste"],resultadosLM_ipea$IN[,"nivel_sajuste"],resultadosLASSO$IN[,"nivel_sajuste"],resultadosRIDGE$IN[,"nivel_sajuste"],resultadosRegTree$IN[,"nivel_sajuste"],resultadosRF$IN[,"nivel_sajuste"])
nivel_cajuste <- cbind(resultadosSARIMA$IN[,"nivel_cajuste"],resultadosKF_univ$IN[,"nivel_cajuste"],resultadosKF_mult$IN[,"nivel_cajuste"],resultadosLM$IN[,"nivel_cajuste"],resultadosLM_ipea$IN[,"nivel_cajuste"],resultadosLASSO$IN[,"nivel_cajuste"],resultadosRIDGE$IN[,"nivel_cajuste"],resultadosRegTree$IN[,"nivel_cajuste"],resultadosRF$IN[,"nivel_cajuste"])
colnames(nivel_sajuste) = colnames(nivel_cajuste) <- c("SARIMA","DFM1","DFM2","LM","LM_ipea","LASSO","RIDGE","RegTree","RF")
...
# MARGEM -------------------------------------
margem <- cbind(resultadosSARIMA$IN[,"margem"],resultadosKF_univ$IN[,"margem"],resultadosKF_mult$IN[,"margem"],resultadosLM$IN[,"margem"],resultadosLM_ipea$IN[,"margem"],resultadosLASSO$IN[,"margem"],resultadosRIDGE$IN[,"margem"],resultadosRegTree$IN[,"margem"],resultadosRF$IN[,"margem"])
colnames(margem) <- c("SARIMA","DFM1","DFM2","LM","LM_ipea","LASSO","RIDGE","RegTree","RF")
...
# INTER --------------------------------------
inter <- cbind(resultadosSARIMA$IN[,"inter"],resultadosKF_univ$IN[,"inter"],resultadosKF_mult$IN[,"inter"],resultadosLM$IN[,"inter"],resultadosLM_ipea$IN[,"inter"],resultadosLASSO$IN[,"inter"],resultadosRIDGE$IN[,"inter"],resultadosRegTree$IN[,"inter"],resultadosRF$IN[,"inter"])
colnames(inter) <- c("SARIMA","DFM1","DFM2","LM","LM_ipea","LASSO","RIDGE","RegTree","RF")
...
erros_rmse <- matrix(NA, ncol = 4, nrow = 13)
erros_mape <- matrix(NA, ncol = 4, nrow = 13)
colnames(erros_rmse) = colnames(erros_mape) <- c("nivel","nivel_cajuste","margem","inter")
rownames(erros_rmse) = rownames(erros_mape) <- c("SARIMA","DFM1","DFM2","LM","LM_ipea","LASSO","RIDGE","RegTree","RF","MEAN","MEDIAN","RMSE","OLS")
...
saveRDS(round(erros_mape,3), "01.models/05.combination/erros_mape.rds")
saveRDS(round(erros_rmse,3),"01.models/05.combination/erros_rmse.rds")
